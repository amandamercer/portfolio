...
<html class="no-js" lang="en" dir="ltr">
  ...
  <body>
    ...
    <h1 class="hide">Forest City Cakes Home</h1>
    ...
    <div class="off-canvas-content" data-off-canvas-content>
      ...
      <div class="top-bar" id="example-animated-menu" data-animate="hinge-in-from-top spin-out">
         <nav class="top-bar-left float-center origNav">
        ...
        <nav class="top-bar-left float-center scrollNav hide">
         <h3 class="hide">Desktop Navigation</h3>
          <ul class="dropdown menu float-center" data-dropdown-menu>
            <li><a href="{{ route('about') }}">ABOUT</a></li>
            <li><a href="{{ route('products') }}">PRODUCTS</a></li>
    ...
    <script type="text/javascript" src="{{ asset('js/navScroll.js')  }}"></script>
